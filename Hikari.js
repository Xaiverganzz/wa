...
Ket : Ketik /resetgame , Untuk Mereset Permainan Yg Ada Di Grup!`, text, {contextInfo: {mentionedJid: [player2]}})
   ...
   sendButMessage(from, titid, `Klik Untuk Ke Game Selanjutnya`, [
       ...
       case 'tebaklirik':
              ...
              case 'command':
               list = []
               listmenu = [`anonymous`,`adventuremenu`,`groupmenu`,`photoxy`,`ephoto`,`randomimage`,`wibu2`,`storymenu`,`porno`,`randomtext`,`islammenu`,`wibumenu`,`stickermenu`,`ownermenu`,`gamemenu`,`funmenu`,`downloadmenu`,`infomenu`,`othermenu`,`owner`,`xaivergroup`,`sewabot`]
